...
#define PARAM_LIST \
    ...
    PARAM_ENTRY(CAT_SETUP,     chargemodes,  CHGMODS,   0,     6,      3,      37 ) \
    ...
    PARAM_ENTRY(CAT_THROTTLE,  idcmax,      "A",       0,      5000,   350,   21 ) \
    PARAM_ENTRY(CAT_THROTTLE,  idcmin,      "A",      -5000,   0,     -350,   22 ) \
    ...
    PARAM_ENTRY(CAT_CONTACT,   udcsw,       "V",       0,      1000,   450,    32 ) \
    ...
    PARAM_ENTRY(CAT_HEATER,    Heater,      HTTYPE,    0,      3,      2,      57 ) \
    PARAM_ENTRY(CAT_HEATER,    Control,     HTCTRL,    0,      2,      1,      58 ) \
    PARAM_ENTRY(CAT_HEATER,    HeatPwr,     "W",       0,      6500,   5000,      59 ) \
    ...
    PARAM_ENTRY(CAT_IOPINS,    Out1Func,    PINFUNCS,  0,      15,     7,      80 ) \
    PARAM_ENTRY(CAT_IOPINS,    Out2Func,    PINFUNCS,  0,      15,     0,      81 ) \
    PARAM_ENTRY(CAT_IOPINS,    Out3Func,    PINFUNCS,  0,      15,     0,      82 ) \
    PARAM_ENTRY(CAT_IOPINS,    SL1Func,     PINFUNCS,  0,      15,     0,      83 ) \
    PARAM_ENTRY(CAT_IOPINS,    SL2Func,     PINFUNCS,  0,      15,     0,      84 ) \
    PARAM_ENTRY(CAT_IOPINS,    PWM1Func,    PINFUNCS,  0,      18,     16,      85 ) \
    PARAM_ENTRY(CAT_IOPINS,    PWM2Func,    PINFUNCS,  0,      18,     16,      86 ) \
    PARAM_ENTRY(CAT_IOPINS,    PWM3Func,    PINFUNCS,  0,      18,     16,      87 ) \
    PARAM_ENTRY(CAT_IOPINS,    GP12VInFunc, PINFUNCS,  0,      13,     12,     98 ) \
    PARAM_ENTRY(CAT_IOPINS,    HVReqFunc,   PINFUNCS,  0,      13,     0,     99 ) \
    PARAM_ENTRY(CAT_IOPINS,    PB1InFunc,   PINFUNCS,  0,      13,     0,     140 ) \
    PARAM_ENTRY(CAT_IOPINS,    PB2InFunc,   PINFUNCS,  0,      13,     0,     141 ) \
    PARAM_ENTRY(CAT_IOPINS,    PB3InFunc,   PINFUNCS,  0,      13,     10,     142 ) \
