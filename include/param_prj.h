...
#define PARAM_LIST                                                             \
  ...
  PARAM_ENTRY(CAT_SETUP, Vehicle, VEHMODES, 0, 8, 2, 6)                        \
  ...
  PARAM_ENTRY(CAT_SETUP, BMSCan, CAN_DEV, 0, 1, 0, 89)                         \
  ...
  PARAM_ENTRY(CAT_SETUP, GearRatio, "", 0, 1, 0.0255, 157)                     \
  ...
  PARAM_ENTRY(CAT_THROTTLE, potmax, "dig", 0, 4095, 2000, 8)                   \
  PARAM_ENTRY(CAT_THROTTLE, pot2min, "dig", 0, 4095, 170, 9)                   \
  PARAM_ENTRY(CAT_THROTTLE, pot2max, "dig", 0, 4095, 820, 10)                  \
  PARAM_ENTRY(CAT_THROTTLE, regenrpm, "rpm", 100, 10000, 1500, 60)             \
  PARAM_ENTRY(CAT_THROTTLE, regenendrpm, "rpm", 100, 10000, 100, 126)          \
  PARAM_ENTRY(CAT_THROTTLE, regenmax, "%", -35, 0, 0, 61)                      \
  PARAM_ENTRY(CAT_THROTTLE, regenBrake, "%", -35, 0, -10, 122)                 \
  PARAM_ENTRY(CAT_THROTTLE, regenramp, "%/10ms", 0.1, 100, 1, 68)              \
  PARAM_ENTRY(CAT_THROTTLE, potmode, POTMODES, 0, 1, 1, 11)                    \
  ...
  PARAM_ENTRY(CAT_THROTTLE, throtramp, "%/10ms", 1, 100, 1, 13)                \
  PARAM_ENTRY(CAT_THROTTLE, revlim, "rpm", 0, 20000, 7000, 15)                 \
  ...
  PARAM_ENTRY(CAT_THROTTLE, idcmax, "A", 0, 5000, 300, 21)                     \
  PARAM_ENTRY(CAT_THROTTLE, idcmin, "A", -5000, 0, -300, 22)                   \
  ...
  PARAM_ENTRY(CAT_THROTTLE, throtmaxRev, "%", 0, 100, 80, 123)                 \
  ...
  PARAM_ENTRY(CAT_CHARGER, BattCap, "kWh", 0.1, 250, 30, 38)                   \
  PARAM_ENTRY(CAT_CHARGER, Voltspnt, "V", 0, 1000, 395, 40)                    \
  PARAM_ENTRY(CAT_CHARGER, Pwrspnt, "W", 0, 12000, 3000, 41)                   \
  PARAM_ENTRY(CAT_CHARGER, IdcTerm, "A", 0, 150, 0.18, 56)                     \
  ...
  PARAM_ENTRY(CAT_HEATER, Heater, HTTYPE, 0, 5, 2, 57)                         \
  PARAM_ENTRY(CAT_HEATER, Control, HTCTRL, 0, 2, 1, 58)                        \
  PARAM_ENTRY(CAT_HEATER, HeatPwr, "W", 0, 6500, 6500, 59)                     \
  PARAM_ENTRY(CAT_HEATER, HeatPercnt, "%", 0, 100, 90, 124)                    \
  ...
  PARAM_ENTRY(CAT_IOPINS, Out1Func, PINFUNCS, 0, 17, 7, 80)                    \
  PARAM_ENTRY(CAT_IOPINS, Out2Func, PINFUNCS, 0, 17, 0, 81)                    \
  PARAM_ENTRY(CAT_IOPINS, Out3Func, PINFUNCS, 0, 17, 0, 82)                    \
  PARAM_ENTRY(CAT_IOPINS, SL1Func, PINFUNCS, 0, 17, 0, 83)                     \
  PARAM_ENTRY(CAT_IOPINS, SL2Func, PINFUNCS, 0, 17, 0, 84)                     \
  PARAM_ENTRY(CAT_IOPINS, PWM1Func, PINFUNCS, 0, 22, 18, 85)                   \
  PARAM_ENTRY(CAT_IOPINS, PWM2Func, PINFUNCS, 0, 22, 18, 86)                   \
  PARAM_ENTRY(CAT_IOPINS, PWM3Func, PINFUNCS, 0, 22, 18, 87)                   \
  PARAM_ENTRY(CAT_IOPINS, GP12VInFunc, PINFUNCS, 0, 13, 12, 98)                \
  PARAM_ENTRY(CAT_IOPINS, HVReqFunc, PINFUNCS, 0, 13, 11, 99)                  \
  PARAM_ENTRY(CAT_IOPINS, PB1InFunc, PINFUNCS, 0, 13, 0, 140)                  \
  PARAM_ENTRY(CAT_IOPINS, PB2InFunc, PINFUNCS, 0, 13, 0, 141)                  \
  PARAM_ENTRY(CAT_IOPINS, PB3InFunc, PINFUNCS, 0, 13, 0, 142)                  \
  ...
  PARAM_ENTRY(CAT_PWM, Tim3_Presc, "", 1, 72000, 8999, 100)                    \
  PARAM_ENTRY(CAT_PWM, Tim3_Period, "", 1, 100000, 3999, 101)                  \
  PARAM_ENTRY(CAT_PWM, Tim3_1_OC, "", 1, 100000, 2000, 102)                    \
  PARAM_ENTRY(CAT_PWM, Tim3_2_OC, "", 1, 100000, 2000, 103)                    \
  PARAM_ENTRY(CAT_PWM, Tim3_3_OC, "", 1, 100000, 2000, 104)                    \
  ...
  VALUE_ENTRY(VessAlive, ONOFF, 2112)                                          \
// Next value Id: 2113
...
#define PINFUNCS                                                               \
  ...
  "16=ShiftLockNO, 17=PreHeatOut, 18=PwmTim3, 19=CpSpoof,"                     \
